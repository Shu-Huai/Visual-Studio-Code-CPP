...
public:
	//  顺序二叉树的函数成员:
	SeqBinaryTree(int size = DEFAULT_SIZE);					   // 构造函数
	virtual ~SeqBinaryTree();								   // 析构函数
	...
	SeqBinaryTree(const ElemType &e, int size = DEFAULT_SIZE); // 建立以e为根的二叉树
	SeqBinaryTree(const SeqBinaryTree<ElemType> &t);		   // 复制构造函数
	SeqBinaryTree(ElemType es[], int ta[], int size = DEFAULT_SIZE);
	// 由es[]、ta[]与size构造二叉树
	SeqBinaryTree<ElemType> &operator=(const SeqBinaryTree<ElemType> &t);
	// 赋值运算符重载
...
template <class ElemType>
void DisplayBTWithTreeShape(SeqBinaryTree<ElemType> &bt);
//	树状形式显示二叉树
template <class ElemType>
...
template <class ElemType>
SeqBinaryTree<ElemType> &CreateBinaryTree(ElemType pre[], ElemType in[], int n, int size = DEFAULT_SIZE);
// 已知先序和中序序列构造二叉树

// 顺序二叉树类的实现部分
template <class ElemType>
bool SeqBinaryTree<ElemType>::IsNodeEmpty(int p) const
...
template <class ElemType>
Status SeqBinaryTree<ElemType>::GetElem(int p, ElemType &e)
...
template <class ElemType>
Status SeqBinaryTree<ElemType>::SetElem(int p, const ElemType &e)
...
template <class ElemType>
void SeqBinaryTree<ElemType>::SetNodeEmpty(int p)
// 操作结果：将结点p置空
{
...
template <class ElemType>
SeqBinaryTree<ElemType>::SeqBinaryTree(int size)
// 操作结果：构造一棵空二叉树
{
...
template <class ElemType>
int SeqBinaryTree<ElemType>::GetRoot() const
// 操作结果：返回二叉树的根结点
{
	if (tag[0] == 1)
		return 0;
...
template <class ElemType>
bool SeqBinaryTree<ElemType>::IsEmpty() const
// 操作结果：判断二叉树是否为空
{
...
template <class ElemType>
int SeqBinaryTree<ElemType>::Height(int r) const
// 操作结果：返回以r为根的二叉树的高
{
...
template <class ElemType>
int SeqBinaryTree<ElemType>::Height() const
// 操作结果：返回二叉树的高
{
	return Height(0);
}
...
template <class ElemType>
int SeqBinaryTree<ElemType>::NodeCount(int r) const
...
template <class ElemType>
int SeqBinaryTree<ElemType>::NodeCount() const
// 操作结果：返回二叉树的结点个数
{
	return NodeCount(0);
}
...
template <class ElemType>
int SeqBinaryTree<ElemType>::LeftChild(const int p) const
// 操作结果：返回二叉树结点p的左孩子
{
...
template <class ElemType>
int SeqBinaryTree<ElemType>::RightChild(const int p) const
// 操作结果：返回二叉树结点p的右孩子
{
...
template <class ElemType>
int SeqBinaryTree<ElemType>::LeftSibling(const int p) const
// 操作结果：返回二叉树结点p的左兄弟
{
...
template <class ElemType>
int SeqBinaryTree<ElemType>::RightSibling(const int p) const
// 操作结果：返回二叉树结点p的右兄弟
{
...
template <class ElemType>
int SeqBinaryTree<ElemType>::Parent(const int p) const
// 操作结果：返回二叉树结点p的双亲
{
	return p > 0 ? (p - 1) / 2 : -1;
}
...
template <class ElemType>
int SeqBinaryTree<ElemType>::Find(const ElemType &e) const
...
template <class ElemType>
Status SeqBinaryTree<ElemType>::InsertLeftChild(int p, const ElemType &e)
...
template <class ElemType>
Status SeqBinaryTree<ElemType>::InsertRightChild(int p, const ElemType &e)
...
template <class ElemType>
Status SeqBinaryTree<ElemType>::DeleteLeftChild(int p)
...
template <class ElemType>
Status SeqBinaryTree<ElemType>::DeleteRightChild(int p)
...
template <class ElemType>
SeqBinaryTree<ElemType>::SeqBinaryTree(const ElemType &e, int size)
...
template <class ElemType>
SeqBinaryTree<ElemType>::SeqBinaryTree(const SeqBinaryTree<ElemType> &t)
...
template <class ElemType>
SeqBinaryTree<ElemType>::SeqBinaryTree(ElemType es[], int ta[], int size)
...
template <class ElemType>
SeqBinaryTree<ElemType> &SeqBinaryTree<ElemType>::operator=(const SeqBinaryTree<ElemType> &t)
...
template <class ElemType>
void DisplayBTWithTreeShape(SeqBinaryTree<ElemType> &bt, int r, int level)
...
template <class ElemType>
int SeqBinaryTree<ElemType>::GetCommonAncestor(int i, int j) const
{
	while (i / 2 != j / 2)
	{
		if (i < j)
